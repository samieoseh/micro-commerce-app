...
router.post('/', createProductValidation, catchAsync(productsController.createProduct));
router.put('/:id',  updateProductValidation, catchAsync(productsController.updateProduct));
router.delete('/:id',  deleteProductValidation, catchAsync(productsController.deleteProduct));
